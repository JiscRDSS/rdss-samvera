class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field solr_name("object_date", :stored_searchable), label: I18n.t('willow.fields.object_date'), itemprop: 'object_date'
    ...
    # RdssCdm Addtitions
    config.add_show_field solr_name("object_date", :displayable), label: I18n.t('willow.fields.date')
