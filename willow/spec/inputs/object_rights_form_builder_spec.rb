...
RSpec.describe ObjectRightsFormBuilder do
  context 'licence' do
    ...
    it_behaves_like 'labelled', FacetsProxy.(described_class,ObjectRightsFormBuilderDummy).licence(required: false), 'Licence', required: false
  ...
  context 'rights_holder' do
    it_behaves_like 'labelled', FacetsProxy.(described_class,ObjectRightsFormBuilderDummy).rights_holder(required: true), 'Rights holder', required: true
    it_behaves_like 'required', FacetsProxy.(described_class,ObjectRightsFormBuilderDummy).rights_holder(required: true)
    it_behaves_like 'labelled', FacetsProxy.(described_class,ObjectRightsFormBuilderDummy).rights_holder, 'Rights holder', required: false
    it_behaves_like 'optional', FacetsProxy.(described_class,ObjectRightsFormBuilderDummy).rights_holder
  ...
  context 'rights_statement' do
    it_behaves_like 'labelled',  FacetsProxy.(described_class,ObjectRightsFormBuilderDummy).rights_statement, 'Rights statement', required: false
    it_behaves_like 'optional',  FacetsProxy.(described_class,ObjectRightsFormBuilderDummy).rights_statement
